...
- **body**: Only if needed to explain _why_ or _how_ (not what—the code shows that). Wrap at 72 chars. Be brutal about compression.

## When to add body

- **Don't**: trivial fixes, obvious refactors, doc updates, config changes where the subject is self-explanatory
- **Do**: breaking changes, complex logic, non-obvious design decisions, migration notes
